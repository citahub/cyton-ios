...
protocol ButtonTagViewDelegate {
...
class ButtonTagView: UIView {
    ...
    var delegate:ButtonTagViewDelegate?
    ...
    var selectArr = Array<UIButton>()//存储选中的按钮
    ...
    func didSetMainViews(){
        ...
        for i in 0...titleArray.count-1 {
            ...
            //计算每个标题文本的宽度
            let itemWidth = returnTextWidth(text: titleArray[i] , font:UIFont.systemFont(ofSize: 15) , viewWidth: ScreenW - 30).width+20
