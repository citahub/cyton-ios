...
class ConTractLastTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        lineV.frame = CGRect(x: 0, y: 39, width: ScreenSize.width * 0.459, height: 5)
    ...
    @IBAction func didClickUTF8Button(_ sender: UIButton) {
        lineV.frame = CGRect(x: ScreenSize.width * 0.459, y: 39, width: ScreenSize.width * 0.459, height: 5)
