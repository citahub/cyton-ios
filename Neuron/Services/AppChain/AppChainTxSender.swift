...
class AppChainTxSender {
    ...
    func send(
        ...
        let sentTransaction = LocationTxDetails(tokenType: .appChain, from: from.address, hash: txHash, transaction: transaction, chainHosts: appChain.provider.url.absoluteString)
